export enum MoveType {
  /* 1  */ BLOCKED_STRIKING = "blocked poking",
  /* 2  */ CALF_KICK = "calf kick hard",
  /* 3  */ CROSS = "cross in the face",
  ...
  /* 15 */ KIMURA = "kimura attempt",
  /* 16 */ REAR_NAKED_CHOKE = "rear naked choke attempt",
