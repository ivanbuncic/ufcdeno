...
export default function Home() {
  if (maintenanceMode) {
    return <h1>We are cleaning up. Will be back soon!</h1>;
  } else {
    return (
      <div>
        <Head>
        ...
        <div class="grid items-center h-screen">
          ...
          <div class="mx-auto text-sm font-normal text-justify p-4 max-w-xl border-dashed border rounded border-purple-600">
            ...
            <p>
              <b>How to play?</b>{" "}
              Click on two fighters from the same class, then click fight to see
              who will win! Use desktop for slightly better experience.
            </p>
            <p>
              ...
              <p>
                <b>Dana</b>{" "}
                (or UFC), pls don't shot this down, we are just playing, this is
